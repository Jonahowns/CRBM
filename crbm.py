...
class cRBM(pgm.PGM):
    def __init__(self,n_v = 100, n_h = 20,visible = 'Bernoulli', hidden='Bernoulli', n_cv =1, n_ch =1, random_state = None, gauge='zerosum',zero_field = False):
        ...
        super(cRBM, self).__init__(n_layers = 2, layers_size = [self.n_v,self.n_h],layers_nature = [visible,hidden], layers_n_c = [self.n_cv,self.n_ch] , layers_name = ['vlayer','hlayer'] )
